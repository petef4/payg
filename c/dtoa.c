...
/* Minor customization by Pete Forman, 2001-02-19:
 *     Alter function names to dtoa_dmg and strtod_dmg to allow these
 *     functions to be called alongside those in the standard library.
 */
...
#ifdef __cplusplus
extern "C" double strtod_dmg(const char *s00, char **se);
extern "C" char *dtoa_dmg(double d, int mode, int ndigits,
